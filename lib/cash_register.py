...
# print(register.total)  # Output: 30

# register.apply_discount(15)  # Apply 15% discount
# print(register.total)  # Output: 25.5

# register.void_last_transaction()  # Remove the last transaction
# print(register.total)  # Output: 10.5
